...
-- 5. Create Source View for Induction Orchestrator
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_sap_source_data]'))
BEGIN
    EXEC('
    CREATE VIEW dbo.vw_sap_source_data AS
    SELECT 
        PO_NUMBER as id,
        PO_NUMBER,
        CASE 
            WHEN PO_NUMBER = ''PO-1001'' THEN ''SN-0001, SN-0002''
            WHEN PO_NUMBER = ''PO-1002'' THEN ''SN-9999''
            ELSE NULL
